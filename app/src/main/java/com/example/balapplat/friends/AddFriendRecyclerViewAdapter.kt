...
class AddFriendRecyclerViewAdapter(private val context: Context, private val items: List<User>,
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bindItem(items[position],statuses[position], listener,position)
    }
    ...
    class ViewHolder(view: View) : RecyclerView.ViewHolder(view){
        ...
        fun bindItem(items: User, statusFriend: Boolean ,listener: (position: Int) -> Unit, position: Int) {
